...
Date:   Thu Aug 27 18:46:01 2026 +0200
...
index af0bf85..a40648c 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/BRIDGE_AGENT_DOC.md
# ── Version APRÈS ce commit.
+++ b/BRIDGE_AGENT_DOC.md
# ── Zone modifiée : ligne 2466 (6 ligne(s)) dans l'ancienne version → ligne 2466 (11 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
...
# ── Zone modifiée : ligne 2515 (9 ligne(s)) dans l'ancienne version → ligne 2520 (77 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
...
# (index — ignorable)
index 6ac6fd8..463a92a 100644
# (avant — fichier suivant)
--- a/new_issue.py
# (après — fichier suivant)
+++ b/new_issue.py
# ── Zone modifiée : ligne 138 (11 ligne(s)) dans l'ancienne version → ligne 138 (30 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -138,11 +138,30 @@ def main():
