...
Date:   Sun Aug 2 23:50:49 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    avant-343-precisions-workflow-changelog-worktree

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/WORKTREES.md b/WORKTREES.md
# ── Identifiants internes git (hash du contenu avant/après). Sans intérêt au quotidien, ignorable.
index 1c6d500..24379b7 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/WORKTREES.md
# ── Version APRÈS ce commit.
+++ b/WORKTREES.md
# ── Zone modifiée : ligne 94 (12 ligne(s)) dans l'ancienne version → ligne 94 (32 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -94,12 +94,32 @@ au quotidien.
...
# ── Zone modifiée : ligne 135 (11 ligne(s)) dans l'ancienne version → ligne 155 (16 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -135,11 +155,16 @@ au quotidien.
