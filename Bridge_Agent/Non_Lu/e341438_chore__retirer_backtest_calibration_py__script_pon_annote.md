...
Date:   Fri Aug 21 16:54:28 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    chore: retirer backtest_calibration.py (script ponctuel, hors dépôt)

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/backtest_calibration.py b/backtest_calibration.py
# ── Ce fichier est supprimé par ce commit.
deleted file mode 100644
# ── Identifiants internes git (hash du contenu avant/après). Sans intérêt au quotidien, ignorable.
index 3a7ba34..0000000
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/backtest_calibration.py
# ── Version APRÈS ce commit.
+++ /dev/null
# ── Zone modifiée : ligne 1 (173 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,173 +0,0 @@
-import json
-import math
-import sys
