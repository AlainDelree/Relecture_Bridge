...
Date:   Thu Aug 6 10:53:26 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    fix #376 : panneau monitoring vue synthetique infrastructure (VM + watchers)

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/CHANGELOG.md b/CHANGELOG.md
# ── Identifiants internes git (hash du contenu avant/après). Sans intérêt au quotidien, ignorable.
index c12e8c4..c0227ab 100644
...
# (index — ignorable)
index 39b3cf5..07f8707 100644
# (avant — fichier suivant)
--- a/static/css/style.css
# (après — fichier suivant)
+++ b/static/css/style.css
# ── Zone modifiée : ligne 293 (6 ligne(s)) dans l'ancienne version → ligne 293 (12 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -293,6 +293,12 @@ button.danger:hover{background:#f8d7da}
...
# (index — ignorable)
index 4fba6b2..e3aee4e 100644
# (avant — fichier suivant)
--- a/static/js/app.js
# (après — fichier suivant)
+++ b/static/js/app.js
# ── Zone modifiée : ligne 1781 (22 ligne(s)) dans l'ancienne version → ligne 1781 (57 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
...
# ── Zone modifiée : ligne 1804 (26 ligne(s)) dans l'ancienne version → ligne 1839 (81 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
