...
Date:   Sun Sep 13 09:10:10 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    doc #538 : documente l'inversion de priorite .conf/code pour la couleur des projets existants (issue #535)

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/BRIDGE_AGENT_DOC.md b/BRIDGE_AGENT_DOC.md
# ── Identifiants internes git (hash du contenu avant/après). Sans intérêt au quotidien, ignorable.
index 92624f2..e4153a5 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/BRIDGE_AGENT_DOC.md
# ── Version APRÈS ce commit.
+++ b/BRIDGE_AGENT_DOC.md
# ── Zone modifiée : ligne 1073 (7 ligne(s)) dans l'ancienne version → ligne 1073 (8 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1073,7 +1073,8 @@ deux, mêmes étapes, mêmes messages, comportement idempotent identique :
...
# ── Zone modifiée : ligne 1134 (6 ligne(s)) dans l'ancienne version → ligne 1135 (44 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1134,6 +1135,44 @@ configs/<nom>.conf`), et committer/pousser les changements du dépôt
