...
Date:   Fri Jul 24 17:08:39 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    Issue #260 : extraction des classes de test d'échange vers test_jeu_echange.py
...
index 7715a20..825de51 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/tests/test_jeu.py
# ── Version APRÈS ce commit.
+++ b/tests/test_jeu.py
# ── Zone modifiée : ligne 33 (8 ligne(s)) dans l'ancienne version → ligne 33 (6 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -33,8 +33,6 @@ from scrabble.regles.plateau import CENTRE, TAILLE
...
-    echanger_jetons,
     ...
     jouer_tours_ia_ui,
     passer_tour,
# ── Zone modifiée : ligne 180 (276 ligne(s)) dans l'ancienne version → ligne 178 (6 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -180,276 +178,6 @@ class TestApiJeuChargementDiffere:
...
diff --git a/tests/test_jeu_echange.py b/tests/test_jeu_echange.py
...
+++ b/tests/test_jeu_echange.py
# ── Zone modifiée : ligne 0 (0 ligne(s)) dans l'ancienne version → ligne 1 (279 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -0,0 +1,279 @@
