...
Date:   Fri Jul 24 17:17:22 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    Issue #262 : extraction de TestApiJeuChargementDiffere vers test_jeu_core_diffusion.py
    
    Note : la classe TestApiJeuDiffusionConfidentialite mentionnée dans l'issue
    n'était pas dans test_jeu.py mais dans test_jeu_pose.py ; seule la classe
    TestApiJeuChargementDiffere a été extraite.
...
index fcb0415..d02055b 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/tests/test_jeu.py
# ── Version APRÈS ce commit.
+++ b/tests/test_jeu.py
# ── Zone modifiée : ligne 64 (113 ligne(s)) dans l'ancienne version → ligne 64 (6 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -64,113 +64,6 @@ class TestPartieDemo:
...
diff --git a/tests/test_jeu_core_diffusion.py b/tests/test_jeu_core_diffusion.py
# ── Ce fichier n'existait pas avant ce commit : il vient d'être créé.
new file mode 100644
# (index — ignorable)
index 0000000..c59f3fa
# (avant — fichier suivant)
--- /dev/null
# (après — fichier suivant)
+++ b/tests/test_jeu_core_diffusion.py
