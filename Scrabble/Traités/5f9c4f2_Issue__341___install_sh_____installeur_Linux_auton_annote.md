...
Date:   Sat Aug 1 22:24:23 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    Issue #341 : install.sh — installeur Linux autonome pour Scrabble (Ubuntu 24.04)
...
index 0000000..5a95db9
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- /dev/null
# ── Version APRÈS ce commit.
+++ b/install.sh
# ── Zone modifiée : ligne 0 (0 ligne(s)) dans l'ancienne version → ligne 1 (138 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -0,0 +1,138 @@
+#!/usr/bin/env bash
+#
