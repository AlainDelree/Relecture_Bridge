...
Date:   Fri Jul 24 16:53:31 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    Issue #258 : extraction des classes de test de tirage d'ordre vers test_jeu_tirage_ordre.py
    
    Déplacement de 5 classes de tests/test_jeu.py vers tests/test_jeu_tirage_ordre.py :
    - TestDetailTirageOrdre
    - TestApiConfidentialite
    - TestThemePlateau
    - TestApiJeuTirageOrdre
    - TestFinaliserEntreeVueJeu
...
index 3db20fc..7d64fd5 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/tests/test_jeu.py
# ── Version APRÈS ce commit.
+++ b/tests/test_jeu.py
# ── Zone modifiée : ligne 37 (90 ligne(s)) dans l'ancienne version → ligne 37 (6 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -37,90 +37,6 @@ from scrabble.ui.jeu import (
 )
...
# ── Zone modifiée : ligne 1086 (129 ligne(s)) dans l'ancienne version → ligne 1002 (6 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1086,129 +1002,6 @@ class TestApiJeuRecommencer:
...
# ── Zone modifiée : ligne 1733 (70 ligne(s)) dans l'ancienne version → ligne 1526 (6 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1733,70 +1526,6 @@ class TestApiJeuDiffusionConfidentialite:
         api._diffuser()
...
diff --git a/tests/test_jeu_tirage_ordre.py b/tests/test_jeu_tirage_ordre.py
# ── Ce fichier n'existait pas avant ce commit : il vient d'être créé.
new file mode 100644
# (index — ignorable)
index 0000000..b01fa91
# (avant — fichier suivant)
--- /dev/null
# (après — fichier suivant)
+++ b/tests/test_jeu_tirage_ordre.py
# ── Zone modifiée : ligne 0 (0 ligne(s)) dans l'ancienne version → ligne 1 (310 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -0,0 +1,310 @@
