...
Date:   Thu Aug 13 21:48:06 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    README: English first, French second

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/README.md b/README.md
# ── Identifiants internes git (hash du contenu avant/après). Sans intérêt au quotidien, ignorable.
index d3bc7c0..c861d5e 100644
...
# ── Zone modifiée : ligne 10 (6 ligne(s)) dans l'ancienne version → ligne 10 (134 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -10,6 +10,134 @@
...
# ── Zone modifiée : ligne 136 (131 ligne(s)) dans l'ancienne version → ligne 264 (3 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -136,131 +264,3 @@ Les contributions sont les bienvenues ! Ouvrez une **Issue** pour signaler un bu
 ### Licence
