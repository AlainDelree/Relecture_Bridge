...
Date:   Mon Sep 7 18:14:08 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    Retrait de export_chesscoach (déplacé vers le dépôt ChessCoach)

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/alchess_err.txt b/alchess_err.txt
...
# (index — ignorable)
index 6b3e07b..0000000
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/export_chesscoach/NOTES_EXPORT.md
# ── Version APRÈS ce commit.
+++ /dev/null
# ── Zone modifiée : ligne 1 (172 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,172 +0,0 @@
...
deleted file mode 100644
# (index — ignorable)
index 0ab95c5..0000000
# (avant — fichier suivant)
--- a/export_chesscoach/engine_stockfish.py
# (après — fichier suivant)
+++ /dev/null
# ── Zone modifiée : ligne 1 (485 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,485 +0,0 @@
-"""
...
deleted file mode 100644
# (index — ignorable)
index 01fcc0e..0000000
# (avant — fichier suivant)
--- a/export_chesscoach/library_manager.py
# (après — fichier suivant)
+++ /dev/null
# ── Zone modifiée : ligne 1 (243 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,243 +0,0 @@
-"""
...
deleted file mode 100644
# (index — ignorable)
index 1776fb9..0000000
# (avant — fichier suivant)
--- a/export_chesscoach/llm_coach.py
# (après — fichier suivant)
+++ /dev/null
# ── Zone modifiée : ligne 1 (172 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,172 +0,0 @@
...
deleted file mode 100644
# (index — ignorable)
index 2b355da..0000000
# (avant — fichier suivant)
--- a/export_chesscoach/socketio_pgn_handlers.py
# (après — fichier suivant)
+++ /dev/null
# ── Zone modifiée : ligne 1 (79 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,79 +0,0 @@
-"""
...
deleted file mode 100644
# (index — ignorable)
index 44ec60d..0000000
# (avant — fichier suivant)
--- a/export_chesscoach/static/board.css
# (après — fichier suivant)
+++ /dev/null
# ── Zone modifiée : ligne 1 (145 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,145 +0,0 @@
-/*
...
deleted file mode 100644
# (index — ignorable)
index 7c53b27..0000000
# (avant — fichier suivant)
--- a/export_chesscoach/static/board.js
# (après — fichier suivant)
+++ /dev/null
# ── Zone modifiée : ligne 1 (622 ligne(s)) dans l'ancienne version → ligne 0 (0 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -1,622 +0,0 @@
-/*
