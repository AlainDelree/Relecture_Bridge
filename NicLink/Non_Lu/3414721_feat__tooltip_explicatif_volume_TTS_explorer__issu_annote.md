...
Date:   Tue Aug 18 09:46:42 2026 +0200

# ── Message de commit : résumé de l'intention du changement, écrit par celui qui a committé.
    feat: tooltip explicatif volume TTS explorer (issue #177, suite #176)

# ── Début du diff pour CE fichier précis. a/ = version avant, b/ = version après (identiques si le fichier n'a pas été renommé).
diff --git a/nicsoft/web/static/i18n/de.json b/nicsoft/web/static/i18n/de.json
# ── Identifiants internes git (hash du contenu avant/après). Sans intérêt au quotidien, ignorable.
index 8723298..07de1ac 100644
# ── Version AVANT ce commit (/dev/null = le fichier n'existait pas).
--- a/nicsoft/web/static/i18n/de.json
# ── Version APRÈS ce commit.
+++ b/nicsoft/web/static/i18n/de.json
# ── Zone modifiée : ligne 256 (7 ligne(s)) dans l'ancienne version → ligne 256 (7 ligne(s)) dans la nouvelle. Une ligne '+' = ajoutée, '-' = supprimée, sans signe = contexte inchangé.
@@ -256,7 +256,7 @@
...
+  "opening_explorer.tts.volume": "Lautstärke (gilt ab dem nächsten Text)",
...
+  "opening_explorer.tts.volume": "Volume (applies to next speech)",
...
-  "opening_explorer.tts.volume": "Volume",
+  "opening_explorer.tts.volume": "Volume (s'applique au texte suivant)",
